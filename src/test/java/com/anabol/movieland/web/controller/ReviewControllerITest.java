...
public class ReviewControllerITest {
    ...
    public void testAddReview() throws Exception {
        ...
        mockMvc.perform(get("/movie/1").contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
                .andExpect(status().isOk())
                ...
                .andExpect(jsonPath("$.reviews[2].id", is(3)))  // the newly added review
                .andExpect(jsonPath("$.reviews[2].user.id", is(1)))
                .andExpect(jsonPath("$.reviews[2].user.nickName", is("Дарлин Эдвардс")))
                .andExpect(jsonPath("$.reviews[2].text", is("Very bad movie")));
    }
}
